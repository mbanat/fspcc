...
class TwoPassAssembler {
	...
	static void pass1() throws Exception {
		BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("2passinput.txt")));
	...
	static void initializeTables() throws Exception {
		...
		String s;
		BufferedReader br;
		br = new BufferedReader(new InputStreamReader(new FileInputStream("2passmot.txt")));
		while((s = br.readLine()) != null) {
			StringTokenizer st = new StringTokenizer(s, " ", false);
			mot.add(new Tuple(st.nextToken(), st.nextToken(), st.nextToken(), st.nextToken()));
		}
		br = new BufferedReader(new InputStreamReader(new FileInputStream("2passpot.txt")));
		while((s = br.readLine()) != null) {
			pot.add(s);
		}
